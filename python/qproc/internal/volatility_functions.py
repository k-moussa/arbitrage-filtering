...
def discounted_black(forward, strike, vol, expiry, discount_factor, call_one_else_put_minus_one):
    return discount_factor*black(forward, strike, vol, expiry, call_one_else_put_minus_one)
